...
$intro = [
    ...
    'description' => 'Новая линейка брендовых кремов для лица Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod  ut labore et dolore magna aliqua.',
];

$laboratory = [
    'title' => 'Наша лаборатория по изготовлению ',
    'description' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.',
    'image' => '../../images/content/laboratory/laboratory-item.jpg',
    'advantages' => [
        [
            'icon' => '../../images/content/laboratory/laboratory-icon-1.png',
...
$reviews = [
    'title' => 'Свяжитесь с нами, чтобы заказать крем',
